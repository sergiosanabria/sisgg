...
class CategoriaProductoProduccionType extends AbstractType
{
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'SisGG\FinalBundle\Entity\CategoriaProductoProduccion'
        ));
    }

    public function getName()
    {
        return 'sisgg_finalbundle_categoriaproductoproducciontype';
    }
}
